...
class FirebaseAuthenticationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<FirebaseAuthBloc, FirebaseAuthState>(
      // bloc: FirebaseAuthBloc()..add(AuthCheckedCurrentUser()),
                ...
                child: ListView(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        if (state.user != null) ...[
                          ...
                          _state("Is Annoymouse", "${state.user!.isAnonymous}"),
                          _state(
                    ...
                    _button(context: context, event: [
                      ...
                      (state.user == null || state.isSocialSignIn),
                      (state.user == null || !state.isSocialSignIn)
                    ]),
                    _title("Sign In"),
                    _button(context: context, event: [
                    ...
                    _button(context: context, event: [], content: [
                      ...
                      () {
                        ...
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => FirebaseAuthInPutScreen(
                                  type: AuthenticationType.emailSignIn,
                                )));
                      },
                      () {
                        HapticFeedback.mediumImpact();
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => FirebaseAuthInPutScreen(
                                  type: AuthenticationType.phoneSignIn,
                                )));
                      },
                    ]),
                    _title("Update"),
                    _button(
                        context: context,
                        event: [],
                        content: ["App Email", "App Password"],
                        isBlocked: [true, true]),
                    _button(
                        context: context,
                        event: [],
                        content: ["Verify Email", "Verify Password"],
                        isBlocked: [true, true]),
                    _title("Verification"),
                    _button(
                        context: context,
